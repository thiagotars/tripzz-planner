...
const Hero = () => {
  return (
    <section className="sm:h-[40rem] xs:h-[36rem] h-[32rem] overflow-hidden relative w-screen bg-light-grey">
      <main className="2xl:px-[17rem] xl:px-[12rem] md:px-20 px-8">
        <div className="z-30 flex flex-col items-center text-center pl-0 lg:pl-20 md:items-start md:text-start">
          <h1 className="xl:text-[3em] lg:text-[2.5em] sm:text-[2em] xs:text-[1.75em] text-[1.5em] font-bold lg:max-w-[37.5rem] sm:max-w-[30rem] max-w-[22rem] md:mt-[14rem] xs:mt-[8rem] mt-[6rem] text-very-dark-grey">
