...
const TripSummary = () => {
  ...
  return (
    <div className="flex flex-col justify-between px-16 pt-16 pb-9 mx-auto mt-[200px] mb-20 h-[424px] w-full max-w-[800px] rounded-[25px] bg-white shadow-md">
      <div className="">
        ...
        <div className="flex flex-col gap-2 text-[14px] mt-10">
      ...
      <div className="flex justify-between pt-6 border-t border-medium-grey">
        <div className="flex items-center">
