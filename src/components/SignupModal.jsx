...
const SignupModal = ({ isOpen, onClose, changeModal }) => {
  ...
  return createPortal(
    <div className="fixed top-[50%] left-[50%] transform translate-y-[-50%] translate-x-[-50%] w-screen h-screen bg-black/10 backdrop-blur-md">
      <button
        className="text-black fixed top-[18%] left-[50%] transform translate-y-[-50%] translate-x-[-50%] z-50 text-[.875em]"
        onClick={onClose}
      >
        X
      </button>
      <div className="z-30 fixed top-[50%] left-[50%] transform translate-y-[-50%] translate-x-[-50%] flex flex-col justify-center bg-white max-w-[400px] p-16 pt-20 text-center rounded-[20px]">
        ...
        <div className="mt-6 text-[.875em]">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-col">
              <button className="font-bold text-[.875em] hover:text-dark-grey mt-6">
                Sign up with email
              </button>
              <button
