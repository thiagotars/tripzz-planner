...
const PlacesToVisit = () => {
    ...
    const fetchPlaces = async () => {
      try {
        const response = await api.get(
          `/api/v1/fetchPlaces/popular-places?city=${tripData.destination.city}`
        );
  ...
  if (loading)
    return <div className="mt-[10rem] font-semibold">Loading...</div>;
  ...
  return (
    <div className="mt-[10rem]">
      ...
      <PlacesToEat city={tripData.destination.city} />
      {/* <div className="mt-12">
